...
function main() {
  ...
  const posTexIndexLoc = gl.getAttribLocation(program, 'positionAndTexcoordIndices');
  ...
  gl.texImage2D(
    ...
    gl.UNSIGNED_BYTE,
    new Uint8Array([
      0xdd, 0x99, 0xdd, 0xaa, 0x88, 0xcc, 0x88, 0xdd, 0xcc, 0x88, 0xcc, 0xaa, 0x88, 0xcc, 0x88, 0xcc,
    ]),
  );
  gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_WRAP_S, gl.CLAMP_TO_EDGE);
  gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_WRAP_T, gl.CLAMP_TO_EDGE);
