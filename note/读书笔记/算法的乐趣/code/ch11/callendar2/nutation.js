...
NUTATION.GetEarthNutationParameter = function(dt, D, M, Mp, F, Omega) {
  let T = dt * 10; /*T是从J2000起算的儒略世纪数*/
  let T2 = T * T;
  let T3 = T2 * T;
  /*平距角（如月对地心的角距离）*/
  D = 297.85036 + 445267.11148 * T - 0.0019142 * T2 + T3 / 189474.0;

  /*太阳（地球）平近点角*/
  M = 357.52772 + 35999.05034 * T - 0.0001603 * T2 - T3 / 300000.0;
...
NUTATION.CalcEarthObliquityNutation = function(dt) {
  let T = dt * 10; /*T是从J2000起算的儒略世纪数*/
  let D, M, Mp, F, Omega;
...
module.exports.NUTATION = NUTATION;
