...
// 1. 语句(Statements): 循环, if判断, 异常处理, with 等等
...
// 2. 表达式(Expressions): 表达式是一组代码的集合, 它返回一个值, 表达式是另一个非常常见的语法
...
// 3. 声明(Declarations): 声明分为变量声明和函数声明
